...
def duckduckgo_search(prompt: str) -> str:
    start_time = time.time()
    message = get_search_message(prompt)
    message = chat_until_success(message)
    end_time = time.time()
...
if __name__ == "__main__":
    prompt = "what is the application requirement for Master of Computer Science in University of Toronto; explain in one paragraph"  # Replace with your actual query
    print(duckduckgo_search(prompt))